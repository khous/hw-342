...
public class AvlTree {
    ...
    /**
     * Get a specified number of most frequent words
     * TODO, ensure that no AvlNodes leak out uncloned
     * Do a preorder traversal, it's possible that the most frequent nodes are clustered in the mid levels
     *
     * @param numberOfFrontRunners
     * @return
     */
    public AvlNode[] getMostFrequent (int numberOfFrontRunners) {
